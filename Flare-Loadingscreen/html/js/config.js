...
const config = {
    ...
    musicVolume: 0.3, // Standardlautstärke (0.0 bis 1.0)
    ...
    team: [
        {
            ...
            avatarImage: 'assets/logo.png' // Bild aus Assets-Ordner
        },
        {
            name: 'Lisa Schmidt',
            role: 'Moderator',
            description: 'Support & Community-Management',
            avatar: 'M' // Fallback: Buchstabe
        },
        {
            name: 'Thomas Weber',
            role: 'Admin',
            description: 'Technischer Support & Entwicklung',
            avatarImage: 'assets/team/developer.png'
        },
        {
            name: 'Sarah Müller',
            role: 'Supporter',
        ...
        },
        {
            ...
            avatarImage: 'assets/team/coder.png'
        },
        {
            name: 'Julia Becker',
            role: 'Supporter',
